                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">michael@gmail.com</td>
...
const alert = Vue.reactive(JSON.parse(initialAlert));
const selection = Vue.ref<null | Selection[]>(null);
...
async function select(recordIndex: number) {
